...
namespace Gotorz2.Controllers
{
	...
	public class AuthController : ControllerBase
	{
		private string CreateJWT(User user)
		{
			...
			var token = new JwtSecurityToken(issuer: "https://localhost:7180/", audience: "https://localhost:7180/", claims: claims, expires: DateTime.Now.AddMinutes(60), signingCredentials: credentials); 
